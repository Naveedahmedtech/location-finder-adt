        ...
        const routes: Route[] = [
            {
                ...
                distance_summary: response?.distance_summary,
                travel_time_summary: response?.travel_time_summary
            },
        ];
                ...
                if (Array.isArray(leg.routes)) {
                    for (const route of leg.routes) {
                        routes.push({
                            ...
                            distance_summary: route.distance_summary,
                            travel_time_summary: route.travel_time_summary
                        });
                    }
                }
